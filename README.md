...
- [Part 6: Describe Azure cost management and service level agreements](#part-6-describe-azure-cost-management-and-service-level-agreements)
  ...
  - [What factors affect cost?](#what-factors-affect-cost)
    - [Resource type](#resource-type)
    - [Usage meters](#usage-meters)
    - [Resource usage](#resource-usage)
    - [Azure subscription types](#azure-subscription-types)
    - [Azure Marketplace](#azure-marketplace)
  - [Does location or network traffic affect cost?](#does-location-or-network-traffic-affect-cost)
    - [Location](#location)
  - [Zones for billing of network traffic](#zones-for-billing-of-network-traffic)
  - [How can I estimate the total cost?](#how-can-i-estimate-the-total-cost)
  - [Use Azure Advisor to monitor your usage](#use-azure-advisor-to-monitor-your-usage)
  - [Use spending limits to restrict your spending](#use-spending-limits-to-restrict-your-spending)
  - [Use Azure Reservations to prepay](#use-azure-reservations-to-prepay)
  - [Choose low-cost locations and regions](#choose-low-cost-locations-and-regions)
  - [Research available cost-saving offers](#research-available-cost-saving-offers)
  - [Use Azure Cost Management + Billing to control spending](#use-azure-cost-management--billing-to-control-spending)
  - [Apply tags to identify cost owners](#apply-tags-to-identify-cost-owners)
  - [Resize underutilized virtual machines](#resize-underutilized-virtual-machines)
  - [Deallocate virtual machines during off hours](#deallocate-virtual-machines-during-off-hours)
...
Because geographic regions can impact where your network traffic flows, network traffic is a cost influence to consider as well.
That decision would save the company some money.
...
If you have a free trial or a credit-based Azure subscription, you can use spending limits to prevent accidental overrun. At this point, you can upgrade your free trial subscription to a pay-as-you-go subscription. If you have a credit-based subscription and you reach your configured spending limit, Azure suspends your subscription until a new billing period begins. A related concept is quotas, or limits on the number of similar resources you can provision within your subscription.
...
As an example, say you run SQL Server on a VM running on Azure. One way to potentially save costs is to move your database from SQL Server on a VM to Azure SQL Database. Azure SQL Database is based on SQL Server. Not only are PaaS services such as Azure SQL Database often less expensive to run, but because they're managed for you, you don't need to worry about software updates, security patches, or optimizing physical storage for read and write operations.
